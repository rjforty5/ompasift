...
float fmax(float *u,int *pos, int size);    /// Max(u), pos contains the index of the maximum 
float fmin(float *u,int *pos, int size);    /// Min(u), pos contains the index of the minimum 	
